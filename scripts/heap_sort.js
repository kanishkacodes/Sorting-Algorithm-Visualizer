...
function swap(i, j) {
    ...
    div_update(divs[j], div_sizes[j], "blue");//updating the height
...
function max_heapify(n, i) {
    ...
    if (l < n && div_sizes[l] > div_sizes[largest]) {
        if (largest != i) {
            div_update(divs[largest], div_sizes[largest], "red");//updating the color
        }

        largest = l;

        div_update(divs[largest], div_sizes[largest], "blue");//updating the color
    }
...
function heap_sort() {
    ...
    for (var i = array_size - 1; i > 0; i--) {
        ...
        div_update(divs[i], div_sizes[i], "rgb(18, 230, 209)");//updating the color
